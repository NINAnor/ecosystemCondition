...
Here we measure the number of species found that are present on the alien species list from the Norwegian biodiversity information center.
...
```
```{r}
alien_sn <- get_observations(subset_year = 2020:2022,
                               subset_habitat = "Semi-nat",
                               subset_species = alien_species)
alien_sn
```
