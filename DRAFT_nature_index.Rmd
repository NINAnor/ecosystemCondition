...
The methodology for calculating NI is well established and has been described in  detail in NINA reports 347, 425, 426, 797, 1130, and 1886 (https://www.nina.no/Publikasjoner/NINA-Rapport) and several international scientific articles (e.g. https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0018930) and will not be elaborated on further here. 
...
Here, we focus primarily on an NI product for wetlands, and the following table gives an overview of the indicators and their respective source data that are included in the official NI for wetlands: 
...
Following calculations, we can have a look at our NI product. 
...
## Prepare export
This last step has not been implemented yet in the NIflex workflow. However, necessary code is already present in the `plotNI_Map` function and can easily be adapted to do this. 
I will get back to and add this last step soon. 
